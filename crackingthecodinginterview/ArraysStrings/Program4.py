...
class Solution:
    ...
    def ideal_code(self, test_param):
        ...
        """
        character_count = collections.Counter(test_param)
        return "".join(dict(character_count).keys())
    ...
    def test_my_code(self):
        ...
        for iteration in range(1, test_case + 1):
            print("_" * 30)
            try:
                param = self.test_case_gen.generate_random_paragraph()
